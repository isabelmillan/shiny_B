  ...
  sidebarLayout(
    sidebarPanel(
      tabsetPanel(
        tabPanel("Inputs", 
                 ...
                 fileInput("datafile", "Cargar datos de un archivo csv", multiple = FALSE, accept = c("csv")),
        ...
        tabPanel("Ajustes de la gráfica",
                 ...
                 selectInput('backgroundcol', label ='Color del fondo',
                             choices=c("Gris" ="gray97","Blanco"="white","Gris Oscuro"="grey90", "Negro"="black"),
                             multiple=FALSE, selectize=TRUE,selected="gray97"),
                 h4("Líneas de referencia"),
                 checkboxInput('identityline', 'Línea identidad')    ,   
    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel("Gráfica de dispersión"  , 
                 ...
                 conditionalPanel(
                   ...
                   fluidRow(
                     column (12, hr()),
                     column (4, uiOutput("colour"),uiOutput("pointsize"))
        ...
        tabPanel("Gráficas de la variable X",
                 h3("Histograma de la variable X "),
                 plotOutput("histplot"),
                 h3("Diagrama de caja"),
                 plotOutput("boxplot")
        ...
        tabPanel("Descarga",
                 h3("Descarga de la gráfica de dispersión"),
                 selectInput(
