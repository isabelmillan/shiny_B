...
# Tabla de valores medios de cada cluster
...
# Agregamos el cluster al que pertenece cada contrato a la base sin normalizar
  ...
  selectedData2 <- reactive({
    ...
    # Función para obtener el análisis estadístico por cluster
  ...
  # Tabla del resumen estadístico de las variables por cluster
...
#Función para agregar el valor de la variable característica de cada cluster
